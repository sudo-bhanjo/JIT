...
//   return (
//     <>
//       {/* Floating Vertical Toggle Button */}
//       <div
//         className="fixed top-1/2 transform -translate-y-1/2 z-50"
//         style={{ right: '-35px' }}
//       >
//         <button
//           className="bg-[#E87722] text-white text-sm font-semibold px-2 py-1 rotate-90 rounded-t-md shadow-lg transition hover:bg-[#3c254a]"
//           onClick={toggleForm}
//         >
//           Enquiry Now
//         </button>
...
//       {/* Floating Right Corner Form */}
//       {showForm && (
//         <div className="fixed top-36 right-7 z-50 bg-white border border-gray-300 rounded-lg shadow-xl w-80 p-4">
//           {/* Close button */}
//           <button
